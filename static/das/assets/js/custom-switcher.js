...
function switcherClick() {
    let ltrBtn, rtlBtn, verticalBtn, horiBtn, horiHoverBtn, switchbtnDefault, switchbtnLight, switchbtnDark,
        switchbtnGlassy, menubgimg1, menubgimg2, menubgimg3, menubgimg4, boxedBtn, fullwidthBtn, scrollableBtn,
        fixedBtn, defaultBtn, closedBtn, iconTextBtn, hoversubBtn, hoversub1Btn, overlayBtn, doubleBtn, defaultlogoBtn,
        centerlogoBtn, resetBtn;
    let html = document.querySelector('html');
